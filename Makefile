...
$(APK): $(EXE) $(APK_FILES)
	...
	cp $(HOME)/ubuntu20-fs/lib/aarch64-linux-gnu/libdl.so.2 $(BUILD_DIR)/android/lib/$(ARCH_APK)/ && \
	...
	cp $(HOME)/ubuntu20-fs/lib/aarch64-linux-gnu/libgcc_s.so.1 $(BUILD_DIR)/android/lib/$(ARCH_APK)/ && \
